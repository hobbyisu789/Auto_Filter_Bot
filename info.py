...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002273332873,-1002724814008').split()]  # Channel id for auto indexing (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mangolv:uBM0qfRO8YqzlqKH@cluster0.vk1kdu4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://Krlove:kumar12321@cluster0.xpctw8r.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DREAMCINEZONE_VERIFY_EXPIRE = int(environ.get('DREAMCINEZONE_VERIFY_EXPIRE', 1))  # Add time in hours
DREAMCINEZONE_VERIFIED_LOG = int(environ.get('DREAMCINEZONE_VERIFIED_LOG', '-1002017490016'))  # Log channel id (make sure bot is admin)
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'fifolink.com')
SHORTLINK_API = environ.get('SHORTLINK_API', 'c003607053d746ca694af908af158f1cfbd51206')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/how_to_download_direct_files/10')  # Tutorial video link for opening shortlink website
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/HdsxSupportTeam_Bot')  # Support group link (make sure bot is admin)
