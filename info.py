...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002273332873').split()]  # Channel id for auto indexing (make sure bot is admin)
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://mandalk7859:mandal123k@cluster0.5xpfnck.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
